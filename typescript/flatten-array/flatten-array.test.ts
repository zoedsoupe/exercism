...
describe('Flatten Array', () => {
  it('no nesting', () => {
    ...
    expect(flattenArray([0, 1, 2])).toEqual(expected);
  });

  it('flattens array with just integers present', () => {
    const expected = [1, 2, 3, 4, 5, 6, 7, 8];
    expect(flattenArray([1, [2, 3, 4, 5, 6, 7], 8])).toEqual(expected);
  });

  it('5 level nesting', () => {
    const expected = [0, 2, 2, 3, 8, 100, 4, 50, -2];
    expect(flattenArray([0, 2, [[2, 3], 8, 100, 4, [[[50]]]], -2])).toEqual(
      expected
    );
  });
  ...
  it('6 level nest list with null values', () => {
    ...
    expect(
      flattenArray([0, 2, [[2, 3], 8, [[100]], undefined, [[undefined]]], -2])
    ).toEqual(expected);
  });
